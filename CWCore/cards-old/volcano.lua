...
function _Create()
    ...
    result.EffectP:AddLayer(
        function (playerI)
            ...
            local ids = CW.IDs(Common.Targetable(playerI, Common.AllPlayers.Buildings()))
            ...
            local creatureIDs = CW.IDs(Common.Targetable(playerI, Common.AllPlayers.CreaturesInLane(laneI)))
